package io.github.xiaoyureed.raincloud.service.support.gateway.util;
...
public class WebFluxUtils {
    ...
    public static Mono<Void> writeJsonResponse(ServerHttpResponse serverHttpResponse, ResponseWrapper<?> responseWrapper) {
        ...
        serverHttpResponse.setStatusCode(HttpStatus.valueOf(responseWrapper.getHttpStatus()));

        String jsonResult = BeanUtils.toJson(responseWrapper);
