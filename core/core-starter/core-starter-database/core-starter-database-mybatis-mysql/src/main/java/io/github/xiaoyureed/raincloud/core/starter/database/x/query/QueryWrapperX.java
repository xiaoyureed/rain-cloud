package io.github.xiaoyureed.raincloud.core.starter.database.x.query;
...
import io.github.xiaoyureed.raincloud.core.starter.database.model.DataSourceConsts;
...
public class QueryWrapperX<T> extends QueryWrapper<T> {
    ...
    public QueryWrapperX<T> limitN(int n) {
        Assert.notNull(DataSourceConsts.DB_TYPE, "获取不到数据库的类型");

        switch (DataSourceConsts.DB_TYPE) {
            case ORACLE:
            case ORACLE_12C:
                super.eq("ROWNUM", n);
                break;
