...
public interface BaseMapperX<T> extends BaseMapper<T> {
    ...
    default ResponseWrapper<List<T>> selectPage(PageParam pageParam, @Param("ew") Wrapper<T> queryWrapper) {
        // MyBatis Plus 查询
        IPage<T> mpPage = MyBatisUtils.buildPage(pageParam);
        selectPage(mpPage, queryWrapper);

        // 转换返回
        return ResponseWrapper.okPage(mpPage.getRecords(), pageParam);
    }
